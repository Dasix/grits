 ...
 *
 * @method Dasix.grits.Renderer#addDataPath
 * @instance
 * @access public
 ...
 * and will, therefore, not be found in the source code.
 *
 * @method Dasix.grits.Renderer#setDataPath
 * @instance
 * @access public
 ...
 * and will, therefore, not be found in the source code.
 *
 * @method Dasix.grits.Renderer#countDataPaths
 * @instance
 * @access public
 ...
 * and will, therefore, not be found in the source code.
 *
 * @method Dasix.grits.Renderer#getDataPaths
 * @instance
 * @access public
 * @param {boolean} [returnAsObject=false] If TRUE, then a standard
 * javascript object will be returned instead of an array.
 * @returns {number} All 'data' paths currently stored in the path configuration object
 */
 ...
 * and will, therefore, not be found in the source code.
 *
 * @method Dasix.grits.Renderer#clearDataPaths
 * @instance
 * @access public
 * @returns {void}
 */
