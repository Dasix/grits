 ...
 *
 * @method Dasix.grits.Renderer#addHelperPath
 * @instance
 * @access public
 ...
 * and will, therefore, not be found in the source code.
 *
 * @method Dasix.grits.Renderer#setHelperPath
 * @instance
 * @access public
 ...
 * and will, therefore, not be found in the source code.
 *
 * @method Dasix.grits.Renderer#countHelperPaths
 * @instance
 * @access public
 ...
 * and will, therefore, not be found in the source code.
 *
 * @method Dasix.grits.Renderer#getHelperPaths
 * @instance
 * @access public
 * @param {boolean} [returnAsObject=false] If TRUE, then a standard
 * javascript object will be returned instead of an array.
 * @returns {number} All 'helper' paths currently stored in the path configuration object
 */
 ...
 * and will, therefore, not be found in the source code.
 *
 * @method Dasix.grits.Renderer#clearHelperPaths
 * @instance
 * @access public
 * @returns {void}
 */
