 ...
 *
 * @class C2C.dustjs.FileSystemLoader
...
qx.Class.define(
	"C2C.dustjs.FileSystemLoader", {

		include : [C2C.dustjs.Loggable],
		extend : qx.core.Object,

		/**
		 * @constructs C2C.dustjs.FileSystemLoader
		 */
		construct : function() {
		...
		members : /** @lends C2C.dustjs.FileSystemLoader **/ {
					...
					function( allRes ) {
						...
						_.each( _.flatten( allRes ), function( r ) {
							...
							if( !_.endsWith( r.name, "/" ) ) {
								...
								var fObj = new C2C.dustjs.File( r.scanPath, r.dir, r.basename );
