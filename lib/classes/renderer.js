	...
	"Dasix.grits.Renderer", {
		...
		members : /** @lends Dasix.grits.Renderer **/ {
			...
			_configure : function( val, old, name ) {
				...
				if( val.components !== undefined ) {
					me._setAllComponentConfig( val.components );
				}

			},

			/**
			 * Sets sub-component configuration for ALL sub-components (dust, sass, etc).
			 * Like Grits configuration, component configuration is _exclusive_,
			 * so omitted configuration values will not affect the configuration
			 ...
			 * @returns {void}
			 */
			_setAllComponentConfig: function( config ) {
				...
				_.each( config, function( componentConfig, componentName ) {
					me.setComponentConfig( componentName, componentConfig );
				});
			...
			/**
			 * Sets sub-component configuration for ONE sub-component (dust, sass, etc).
			 * Like Grits configuration, component configuration is _exclusive_,
			 * so omitted configuration values will not affect the configuration
			 * of the sub-components.
			 *
			 ...
			 * @returns {void}
			 */
			setComponentConfig: function( componentName, componentConfig ) {
				...
				if( tipe( componentConfig ) !== "object" ) {
					return;
				}

				// Pass each config value to `#_setComponentConfigValue()`
				_.each( componentConfig, function( configValue, configKey ) {
					me._setComponentConfigValue( componentName, configKey, configValue );
				});
			 ...
			 * @returns {void}
			 */
			_setComponentConfigValue: function( componentName, configKey, configValue ) {
			 ...
			 * @returns {void}
			 */
			_initComponentConfig: function( componentName ) {
