...
qx.Class.define(
	"Dasix.grits.Renderer", {
		...
		members : /** @lends Dasix.grits.Renderer **/ {
			 ...
			 * for calling {@link Dasix.grits.Renderer#clearAllPaths}
			 * {@link Dasix.grits.Renderer#addRootPath}.
			 *
			 * @instance
			 * @access public
			 ...
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'root'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 ...
			 * for calling {@link Dasix.grits.Renderer#clearHelperPaths} and
			 * {@link Dasix.grits.Renderer#addHelperPath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'helper'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'helper'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 ...
			 * configuration.  This method is just convenient replacement
			 * for calling {@link Dasix.grits.Renderer#clearHandlerPaths} and
			 * {@link Dasix.grits.Renderer#addHandlerPath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'handler'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'handler'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 ...
			 * configuration.  This method is just convenient replacement
			 * for calling {@link Dasix.grits.Renderer#clearPartialPaths} and
			 * {@link Dasix.grits.Renderer#addPartialPath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'partial'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'partial'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 ...
			 * configuration.  This method is just convenient replacement
			 * for calling {@link Dasix.grits.Renderer#clearLayoutPaths} and
			 * {@link Dasix.grits.Renderer#addLayoutPath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'layout'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'layout'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 ...
			 * configuration.  This method is just convenient replacement
			 * for calling {@link Dasix.grits.Renderer#clearContentPaths} and
			 * {@link Dasix.grits.Renderer#addContentPath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'content'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'content'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 ...
			 * configuration.  This method is just convenient replacement
			 * for calling {@link Dasix.grits.Renderer#clearDataPaths} and
			 * {@link Dasix.grits.Renderer#addDataPath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'data'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'data'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			...
			//<editor-fold desc="+++++ Path Management Methods for 'sass' paths +++++">

			/**
			 * Clears any existing 'sass' paths and adds one more into the
			 * configuration.  This method is just convenient replacement
			 * for calling {@link Dasix.grits.Renderer#clearSassPaths} and
			 * {@link Dasix.grits.Renderer#addSassPath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 * to the 'sass' path configuration.
			 * @returns {void}
			 */
			setSassPath : function( newPath ) {
				...
				// Add the new path, or paths
				me.addSassPath( newPath );

			},

			/**
			 * Adds one or more paths to the 'sass' path configuration. This method is
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'sass'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 * paths, to be add to the 'sass' path configuration.
			 * @returns {void}
			 */
			addSassPath : function( newPath ) {

				// Locals
				var me = this;

				// Defer to the `addPathOfType` method
				me.addPathOfType( 'sass', newPath );

			},

			/**
			 * Clears all 'sass' paths from the path configuration. This method is
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'sass'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 */
			clearSassPaths : function() {

				// Locals
				var me = this;

				// Defer to the `clearPathsOfType` method
				me.clearPathsOfType( 'sass' );

			},

			/**
			 * Returns the number of 'sass' paths currently stored in the path
			 * configuration object. This method is a convenience alas because,
			 * internally, this method simply calls {@link Dasix.grits.Renderer#countPathsOfType}
			 * with the first param set to 'sass'.
			 *
			 * @instance
			 * @access public
			 * @returns {number} The number of 'sass' paths currently stored in the path
			 * configuration object
			 */
			countSassPaths : function() {

				// Locals
				var me = this;

				// Defer to the `countPathsOfType` method
				return me.countPathsOfType( "sass" );

			},

			/**
			 * Returns all 'sass' paths currently defined in the renderer's path
			 * configuration object. This method is a convenience alas because,
			 * internally, this method simply calls {@link Dasix.grits.Renderer#getPathsOfType}
			 * with the first param set to 'sass'.
			 *
			 ...
			 * configuration object
			 */
			getSassPaths : function( returnAsObject ) {

				// Locals
				var me = this;

				// Defer to the `getPathsOfType` method
				return me.getPathsOfType( "sass", returnAsObject );

			},

			//</editor-fold>

			//<editor-fold desc="+++++ Path Management Methods for 'sassi' paths +++++">

			/**
			 * Clears any existing 'sassi' paths and adds one more into the
			 * configuration.  This method is just convenient replacement
			 * for calling {@link Dasix.grits.Renderer#clearSassIncludePaths} and
			 * {@link Dasix.grits.Renderer#addSassIncludePath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 * to the 'sassi' path configuration.
			 * @returns {void}
			 */
			setSassIncludePath : function( newPath ) {

				// Locals
				var me = this;

				// Clear existing paths
				me.clearSassIncludePaths();

				// Add the new path, or paths
				me.addSassIncludePath( newPath );

			},

			/**
			 * Adds one or more paths to the 'sassi' path configuration. This method is
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'sassi'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 * paths, to be add to the 'sassi' path configuration.
			 * @returns {void}
			 */
			addSassIncludePath : function( newPath ) {

				// Locals
				var me = this;

				// Defer to the `addPathOfType` method
				me.addPathOfType( 'sassi', newPath );

			},

			/**
			 * Clears all 'sassi' paths from the path configuration. This method is
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'sassi'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 */
			clearSassIncludePaths : function() {

				// Locals
				var me = this;

				// Defer to the `clearPathsOfType` method
				me.clearPathsOfType( 'sassi' );

			},

			/**
			 * Returns the number of 'sassi' paths currently stored in the path
			 * configuration object. This method is a convenience alas because,
			 * internally, this method simply calls {@link Dasix.grits.Renderer#countPathsOfType}
			 * with the first param set to 'sassi'.
			 *
			 * @instance
			 * @access public
			 * @returns {number} The number of 'sassi' paths currently stored in the path
			 * configuration object
			 */
			countSassIncludePaths : function() {

				// Locals
				var me = this;

				// Defer to the `countPathsOfType` method
				return me.countPathsOfType( "sassi" );

			},

			/**
			 * Returns all 'sassi' paths currently defined in the renderer's path
			 * configuration object. This method is a convenience alas because,
			 * internally, this method simply calls {@link Dasix.grits.Renderer#getPathsOfType}
			 * with the first param set to 'sassi'.
			 *
			 ...
			 * @returns {number} The number of 'sassi' paths currently stored in the path
			 * configuration object
			 * @todo Fix the return desc, this one is for count
			 */
			getSassIncludePaths : function( returnAsObject ) {

				// Locals
				var me = this;

				// Defer to the `getPathsOfType` method
				return me.getPathsOfType( "sassi", returnAsObject );
			 ...
			 * configuration.  This method is just convenient replacement
			 * for calling {@link Dasix.grits.Renderer#clearOutputPaths} and
			 * {@link Dasix.grits.Renderer#addOutputPath}.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath A path, or an array of paths, to add
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#addPathOfType} with the first param set to 'output'.
			 *
			 * @instance
			 * @access public
			 * @param {string|string[]} newPath An absolute path, or an array of
			 ...
			 * a convenience alas because, internally, this method simply calls
			 * {@link Dasix.grits.Renderer#clearPathsOfType} with the first param set to 'output'.
			 *
			 * @instance
			 * @access public
			 * @returns {void}
			 ...
			 * exclusively by {@link Dasix.grits.Renderer#_copyStaticContent}.
			 *
			 * @instance
			 * @access private
			...
			/**
			 * Uses a {@link Dasix.grits.MarkdownParser} object to parse a bit of
			...
			_parseMarkdown: function( srcMarkdown ) {
				...
				if( me.$$markdownParser === undefined ) {
					me.$$markdownParser = new Dasix.grits.MarkdownParser();
			...
			/**
			 * Convenience alias for the {@link Dasix.grits.Renderer#addPlugin} method.
			 *
			 * @instance
			 * @access public
			 * @see Dasix.grits.Renderer#addPlugin
			 */
			use : function( plugin ) {
