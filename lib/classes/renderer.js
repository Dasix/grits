		...
		members : /** @lends Dasix.grits.Renderer **/ {
						...
						function( resolve, reject ) {
							...
							dust.render( templateName, context, function( err, out ) {
								...
								if( err ) {
									...
									me.cleanupManager.addTrackedFile( destFile );
			...
			_compileOneTemplate : function( name, srcFile, parseFrontMatter ) {
				...
				if( srcFile.is("md") ) {
					...
					me.log( "markdown.parse", " -> [ Parsing Markdown for Template: '" + name + "'" + markdownNote + " ]" );
					src = me._parseMarkdown( src, debugMarkdown );
