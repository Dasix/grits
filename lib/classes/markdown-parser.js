 ...
 *
 * @class Dasix.grits.MarkdownParser
...
qx.Class.define(
	"Dasix.grits.MarkdownParser", {

		extend : qx.core.Object,

		/**
		 * @constructs Dasix.grits.MarkdownParser
		 */
		construct : function( ) {
		...
		members : /** @lends Dasix.grits.MarkdownParser **/ {
			 ...
			 * It is different from {@link Dasix.grits.MarkdownParser#parse} in
