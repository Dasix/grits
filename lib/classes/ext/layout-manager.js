	...
	"Dasix.grits.ext.LayoutManager", {
		...
		members : /** @lends Dasix.grits.ext.LayoutManager **/ {
			...
			compileAll : function() {
				...
				me.log("debug", "some.topic", "AAAAAAAAAAAAAAAAAAAA");
				me.log("some.topic", "BBBBBBBBBBBBBBBBBBBBBBB");
				me.log("CCCCCCCCCCCCCCCCCCCCCCC");
				/*me.log("XXXXXXXXXXXXXXX");
				me.log("XXXXXXXXXXXXXXX");
				me.log("XXXXXXXXXXXXXXX");
				me.log("XXXXXXXXXXXXXXX");
				me.log("XXXXXXXXXXXXXXX");
				...
				var scanOpts = {
					noMatchHandler: function() {
						me.log("Notice: No Dust.js layouts files were found or loaded!");
					}
				};
			...
			applyLayout: function( srcContent, matterData, contentIsMarkdown ) {
				...
				if( matterData.layout === undefined ) {
					if( defaultLayout !== null ) {
						me.log( "      -> Using default layout: '" + defaultLayout + "'" );
					}
			...
			setDefaultLayout: function( newVal ) {
				...
				// Log it
				if( newVal === null ) {
					me.log("Default layout set to: <null> (none)");
				} else {
					me.log("Default layout set to: '" + newVal + "'");
				}
