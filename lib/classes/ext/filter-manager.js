	...
	"Dasix.grits.ext.FilterManager", {
		...
		members : /** @lends Dasix.grits.ext.FilterManager **/ {
			...
			loadAll : function() {
				...
				var scanOpts = {
					noMatchHandler: function() {
						me.log("debug", "found.none", "No custom Dust.js filters were found or loaded!");
					}
				};
			...
			_loadOne: function( file ) {
				...
				me.log("debug", "load", "Loading filter function ..");
				me.log("debug", "load", " -> Source       : " + filePath );
				me.log("debug", "load", " -> Filter Name : |" + filterName );
			...
			_applyOneBuiltInFilter: function( filterStore, filterName, methodName ) {
				...
				me.log("debug", "built-in", "Adding Built-In Filter: " + filterName);
