	...
	"Dasix.grits.ext.CleanupManager", {
		...
		members : /** @lends Dasix.grits.ext.CleanupManager **/ {
			...
			doCleanBefore: function() {
				...
				// Say Hello
				me.log( "Cleaning all output paths (pre-render cleanup)" );
			...
			doCleanAfter: function() {
				...
				// Say Hello
				me.log( "Cleaning all untracked files (post-render cleanup)" );
