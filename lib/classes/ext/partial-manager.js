	...
	"Dasix.grits.ext.PartialManager", {
		...
		members : /** @lends Dasix.grits.ext.PartialManager **/ {
			...
			compileAll : function() {
				...
				var scanOpts = {
					noMatchHandler: function() {
						me.log("info", "found.none", "No Dust.js partial files were found or loaded!");
					}
				};
			...
			_compileOne: function( file ) {
				...
				me.log("debug", "compile", "Compiling partial..");
				me.log("debug", "compile", " -> Source    : " + file.getAbsoluteFilePath() );
				me.log("debug", "compile", " -> Long Name : " + partialName );
				...
				// Fire an event
				me.emit( "onPartialLoaded", { file: file, partialName: partialName, partialManager: me } );
