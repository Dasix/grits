		...
		members : /** @lends Dasix.grits.ext.ConfigurationManager **/ {
			...
			_initConfigData: function() {
				...
				if( me.$$configData === null ) {
					me.log( "Initializing renderer configuration" );
					me.$$configData = {};
				} else {
					me.log( "Applying new renderer configuration" );
				}
			...
			_stepConfigFile : function( configData ) {
				...
				if( configPath !== null ) {
					configData = me._loadConfigFromFile( configData, configPath );
				}
			...
			_loadConfigFromFile: function( existingConfig, configPath ) {
				...
				// Log it
				me.log( "file", "Loading configuration from file: " + configPath );
