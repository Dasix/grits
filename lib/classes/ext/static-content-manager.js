	...
	"Dasix.grits.ext.StaticContentManager", {
		...
		members : /** @lends Dasix.grits.ext.StaticContentManager **/ {
			...
			_copyInlineContent: function() {
				...
				// Log it
				me.log( "debug", "scan.in-line", "Scanning for in-line static content" );
			...
			_copyOneStaticFile: function( srcFile, relativeTarget ) {
				...
				me.log( "info", "copy.src", "Copying static resource: " + srcFile.getAbsoluteFilePath() );

				if( relativeTarget !== "" ) {
					me.log( "debug", "copy.dest", " -> Rel Target: '" + relativeTarget + "'" );
				}
			...
			_afterCopyOne: function( destFile ) {
				...
				// Log it
				me.log( "debug", "copy.complete", " -> Copied to: '" + destFile.getAbsoluteFilePath() + "'" );
			...
			_copyDedicatedContent : function() {
				...
				// Log it
				me.log( "debug", "scan.dedicated", "Scanning for dedicated static content" );
