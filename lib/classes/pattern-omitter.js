 ...
 * from a string.  This class was created for use by the {@link C2C.dustjs.MarkdownParser}
 * to enable better Dust.js and Markdown compatibility.
 *
 * @class C2C.dustjs.PatternOmitter
...
qx.Class.define(
	"C2C.dustjs.PatternOmitter", {

		extend : qx.core.Object,

		/**
		 * @constructs C2C.dustjs.PatternOmitter
		 */
		...
		members : /** @lends C2C.dustjs.PatternOmitter **/ {
			 ...
			 *
			 * @example
			 * var patternOmitter = new C2C.dustjs.PatternOmitter( name, src, pattern );
