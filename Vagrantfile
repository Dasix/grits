...
Vagrant.configure("2") do |config|
	...
	#    Vagrant VM just to remap ports.
		...
		config.vm.network :forwarded_port, guest: 3550, host: 3550
		config.vm.network :forwarded_port, guest: 3551, host: 3551
		config.vm.network :forwarded_port, guest: 3552, host: 3552
		config.vm.network :forwarded_port, guest: 3553, host: 3553
